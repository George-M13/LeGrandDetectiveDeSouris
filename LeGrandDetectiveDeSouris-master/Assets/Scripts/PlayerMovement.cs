...
public class PlayerMovement : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        if(currentState != PlayerState.falling) count = 0;
        ...
        localVel.z = z * zSpeed;
        if (currentState == PlayerState.pipeclimbing || currentState == PlayerState.pipeswinging || currentState == PlayerState.pipeclimbingturn|| currentState == PlayerState.climbing || currentState == PlayerState.gettingup || currentState == PlayerState.jumping || currentState == PlayerState.falling) {
    ...
    public void Vault(float h) 
    {
        ...
        this.rb.velocity += transform.forward * 2;
        IsGrounded = false;
    }
